            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="https://ui-avatars.com/api/?name={{ auth()->user()->name ?? ""  }}&bold=true&background=0D8ABC&color=fff&size=128" alt="Profile" class="rounded-circle">
                        <h2> {{ auth()->user()->name }} </h2>
                        <h3> {{ auth()->user()->username }} | {{ auth()->user()->role }} </h3>
